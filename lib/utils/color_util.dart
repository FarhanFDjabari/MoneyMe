...
class ColorUtil {
  static Color primaryColor = Color(0XFF009CE3);

  static Color secondaryColor = Color(0XFF40BEF9);

  static Color greenColor = Color(0XFF6BD859);

  static Color redColor = Color(0XFFEF4343);
  ...
  static const Color PurpleLight = Color.fromRGBO(235, 209, 252, 1);

  static const Color PurpleDark = Color.fromRGBO(224, 19, 156, 1);

  static const Color PurpleIcon = Color.fromRGBO(209, 2, 99, 1);

  static const Color PurpleAccent = Color.fromRGBO(193, 106, 250, 1);

  static const Color PurpleLow = Color.fromRGBO(180, 135, 209, 1);

  static const Color PurpleShadow = Color.fromRGBO(209, 2, 99, 0.27); // 27%

  static const Color PurpleBackground = Color.fromRGBO(119, 0, 207, 1);
  ...
  static const Color BlueLight = Color.fromRGBO(98, 0, 238, 1);
